...
--
--     -- 为当前窗口添加边框
--     vim.api.nvim_win_set_config(win_id, { border = "rounded" }) -- 你可以选择 "double", "rounded", "solid", "shadow"
--   end
-- end
--
-- -- 定义一个函数来处理浮动窗口关闭事件
...
--     for _, win in ipairs(wins) do
--       local win_config = vim.api.nvim_win_get_config(win)
--       if win_config.relative ~= "" and win_config.zindex and win_config.zindex > max_zindex then
...
--       vim.api.nvim_win_set_config(top_win, { border = "single" })
--     end
--   end, 50) -- 延迟50毫秒
-- end
--
